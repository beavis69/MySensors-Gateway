...
// Set blinking period
#define MY_DEFAULT_LED_BLINK_PERIOD 1000
...
#define MY_DEFAULT_ERR_LED_PIN LED_BUILTIN
...
// define force refresh period// define force refresh period
// #define PERIOD (1000UL*60*1)
